/**
 * Shared filters for Ionic and covalent bond worksheet (pages 58–125).
 */

export const PAGE_MIN = 58;
export const PAGE_MAX = 125;

export const ALLOWED_QTYPES = new Set(["ionic-bond", "covalent-bond"]);

export function requiresTableOrDiagram(stem) {
...
export function isOutOfScopeTopic(stem) {
  const s = String(stem || "").toLowerCase();
...
export function isBondingBankEntry(entry) {
